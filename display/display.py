...
try:
    ...
    weather_icon = Image.open('icons/sunny_weather_icon.png')
    image1.paste(weather_icon, (56, 56))
    draw = ImageDraw.Draw(image1)


    draw.arc((1, 1, 239, 239), 0, 360, fill=(255, 0, 255))
    draw.arc((2, 2, 238, 238), 0, 360, fill=(255, 0, 255))
    draw.arc((3, 3, 237, 237), 0, 360, fill=(255, 0, 255))
    ...
    Font1 = ImageFont.truetype("HammersmithOne-Regular.ttf", 25)
    Font2 = ImageFont.truetype("HammersmithOne-Regular.ttf", 35)
    Font3 = ImageFont.truetype("HammersmithOne-Regular.ttf", 32)

    draw.text((40, 50), 'London', fill=(128, 255, 128), font=Font2)
    draw.text((74, 150), '20C 10mph', fill = "WHITE", font=Font3)
    ...
    image = Image.open('icons/sunny_icon.jpg')
    weather_icon = Image.open('icons/sunny_weather_icon.png')
    image.paste(weather_icon, (56, 56))
